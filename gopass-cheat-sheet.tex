...
Keep passwords safe with \href{https://gopass.pw}{gopass}. It creates a
...
\hypertarget{create-new-key}{%
\subsubsection{Create new key}\label{create-new-key}}
...
\hypertarget{initialize-gopass-1}{%
\subsubsection{Initialize gopass}\label{initialize-gopass-1}}
